<div class="navbar navbar-light navbar-expand-md bg-light mb-4" role="navigation">
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="nav navbar-nav mr-auto">
			<li class="nav-item"><a class="nav-link" href="<?= HTML::url('/contests') ?>"><span class="glyphicon glyphicon-tower"></span> <?= UOJLocale::get('contests') ?></a></li>
			<li class="nav-item"><a class="nav-link" href="<?= HTML::url('/problems') ?>"><span class="glyphicon glyphicon-hdd"></span> <?= UOJLocale::get('problems') ?></a></li>
			...
			<li class="nav-item"><a class="nav-link" href="<?= HTML::url('/hacks') ?>"><span class="glyphicon glyphicon-alert"></span> <?= UOJLocale::get('hacks') ?></a></li>
