<?php
	...
	$register_form->handle = function() {
		...
		DB::query("replace into contests_registrants (username, user_rating, contest_id, has_participated) values ('{$myUser['username']}', {$myUser['rating']}, {$contest['id']}, 0)");
...
<ul>
	...
	<li>比赛中途可以提交，若同一题有多次提交按<strong>最后一次不是 Compile Error 的提交</strong>算成绩。（其实 UOJ 会自动无视你所有 Compile Error 的提交）</li>
